...
public class ContactApp extends TelephoneBook {
    ...
    // validNam asks for string to check if it has digits between it if yes it will
    // ask again for string
    protected static String validNam() {
    ...
    // validNum method asks for string and check if a string has 10 digits starting
    // by 05 and without any letters otherwise it will ask again
    protected static String validNum() {
        Scanner input = new Scanner(System.in);
    ...
    // containsDigit method take a string and return true if the string has at least
    // one digit otherwise return false

    private static boolean containsDigit(String name) {
    ...
    // containLetter method take a string and return true if the string has at least
    // one english letter otherwise return false
    private static boolean containsLetter(String number) {
